...
def user_interaction(params):
    ...
    input(colorama.Fore.RED + """\nРабота с базой данных... Нажмите Enter для продолжения""" + colorama.Fore.RESET)
    while True:
        user_input = input("""
...
Ввод пользователя -> """)
        if user_input == '0':
            ...
            query = input(colorama.Fore.RED + "Введите ключевые слова через пробел: " + colorama.Fore.RESET)
